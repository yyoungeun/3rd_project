...
public class CommentController {
	...
	public String get_retrieve(Search search, Model model, HttpServletRequest request) {
		...
		List<Comment> list = (List<Comment>)commentService.get_retrieve(search);
...
//	}
//	
	@RequestMapping(value = "comment/do_update.do", method = RequestMethod.GET, produces = "application/json;charset=UTF-8")
	@ResponseBody
	public String do_update(Comment comment) {
		
		LOG.debug("================================");
		LOG.debug("comment:"+comment);
		LOG.debug("================================");
		
		int flag = commentService.do_update(comment);
	...
	@RequestMapping(value = "comment/do_save.do", method = RequestMethod.GET, produces = "application/json;charset=UTF-8")
	@ResponseBody
	public String do_save(Comment comment) {
		
		LOG.debug("================================");
		LOG.debug("comment:"+comment);
		LOG.debug("================================");
		
		int flag = commentService.do_save(comment);
	...
	@RequestMapping(value = "comment/do_delete.do", method = RequestMethod.GET, produces = "application/json;charset=UTF-8")
	@ResponseBody
	public String do_delete(Comment comment) {
		
		LOG.debug("================================");
		LOG.debug("comment:"+comment);
		LOG.debug("================================");
		
		int flag = commentService.do_delete(comment);
