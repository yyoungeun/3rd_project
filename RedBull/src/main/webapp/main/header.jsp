                ...
                <ul class="nav navbar-nav center_nav">
                  ...
                  <c:choose>
	                  ...
	                  <li class="nav-item active submenu dropdown">
	                    ...
	                    <ul class="dropdown-menu">
	                      <li class="nav-item">
	                        <a class="nav-link" href="${context}/user/get_updateForm.do"><spring:message code="message.header.memberupdate" /></a>
	                      </li> 
	                      <li class="nav-item">
	                        <a class="nav-link" href="${context}/pay/get_payRetrieve.do"><spring:message code="message.header.myshopping" /></a>
	                      </li> 
	                      <li class="nav-item">
	                        <a class="nav-link" href="${context}/good/get_retrieve.do"><spring:message code="message.header.mygood" /></a>
	                      </li> 
	                      <li class="nav-item">
	                        <a class="nav-link" href="${context}/myboard/get_aRetrieve.do"><spring:message code="message.header.myquestion" /></a>
	                      </li> 
	                    </ul>
	                  </li>
                  	</c:when>
